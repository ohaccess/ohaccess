...
// of the product the general public uses. 16 languages (see LANGS).
//
// Rules of the road:
...
export interface RegisterStrings {
  ...
  errName: string
  errEmail: string
  // Generic — the form accepts numbers from any country (2026-08-19); the
  // specific NANP reasons stay English-only (see RegisterClient.phoneErrMsg).
  errPhone: string
  errTimeline: string
  errSubmit: string
  requestBtn: string
  ...
  consentSms: string
  // Same consent, for numbers the codeword reaches by WhatsApp instead of
  // SMS (countries our SMS routes don't serve — lib/messaging-channel.ts).
  // No STOP/HELP line: those are SMS carrier keywords, not WhatsApp ones.
  ...
  sentBody2: string
  checkPhone: string
  // WhatsApp-channel variants of sentBody1 / checkPhone.
  sentBody1WhatsApp: string
  ...
  // Short call-to-action for the feedback card's banner heading and the
  // floating "scroll to it" chip on the success screen.
...
const en: RegisterStrings = {
  ...
  requestBtn: 'Request Codeword →',
  requestBtnName: 'Request Codeword',
  submitting: 'Sending your code...',
  consentSms: 'By entering your number and tapping {button}, you agree to receive a one-time SMS codeword from ohACCESS to enter this open house. Message & data rates may apply. Reply STOP to opt out, HELP for help.',
  consentWhatsApp: 'By entering your number and tapping {button}, you agree to receive a one-time codeword from ohACCESS by WhatsApp to enter this open house. Message & data rates may apply.',
  ...
  sentBody1WhatsApp: 'Your codeword was sent to you on WhatsApp, with a backup codeword sent to your email.',
  checkWhatsApp: '✓ Codeword was sent to you on WhatsApp.',
  ...
  feedbackNudge: 'After your tour: rate this home',
  agreementTitle: 'One more step before your tour',
  agreementIntro: 'The host needs you to review and sign the following before entering. It takes about 20 seconds, and a signed copy is emailed to you. If you choose not to sign, you will not be able to tour the property today.',
...
const es: RegisterStrings = {
  ...
  errPhone: 'Por favor ingresa un número de móvil válido',
  errTimeline: 'Por favor selecciona un plazo de compra',
  errSubmit: 'Algo salió mal. Por favor intenta de nuevo.',
  requestBtn: 'Solicitar palabra clave →',
  requestBtnName: 'Solicitar palabra clave',
  submitting: 'Enviando tu código...',
  consentSms: 'Al ingresar tu número y tocar {button}, aceptas recibir una palabra clave de un solo uso por SMS de ohACCESS para entrar a esta casa abierta. Pueden aplicar tarifas de mensajes y datos. Responde STOP para cancelar, HELP para ayuda.',
  consentWhatsApp: 'Al ingresar tu número y tocar {button}, aceptas recibir una palabra clave de un solo uso de ohACCESS por WhatsApp para entrar a esta casa abierta. Pueden aplicar tarifas de mensajes y datos.',
  ...
  sentBody1WhatsApp: 'Tu palabra clave fue enviada por WhatsApp, con una palabra clave de respaldo enviada a tu correo.',
  checkWhatsApp: '✓ Tu palabra clave fue enviada por WhatsApp.',
  ...
  feedbackNudge: 'Después del recorrido: califica esta casa',
  agreementTitle: 'Un paso más antes de tu visita',
  agreementIntro: 'El anfitrión necesita que revises y firmes lo siguiente antes de entrar. Toma unos 20 segundos y recibirás una copia firmada por correo. Si decides no firmar, no podrás recorrer la propiedad hoy.',
...
const vi: RegisterStrings = {
  ...
  errPhone: 'Vui lòng nhập số điện thoại di động hợp lệ',
  errTimeline: 'Vui lòng chọn thời gian dự định mua nhà',
  errSubmit: 'Đã xảy ra lỗi. Vui lòng thử lại.',
  requestBtn: 'Yêu cầu mật mã →',
  requestBtnName: 'Yêu cầu mật mã',
  submitting: 'Đang gửi mã của bạn...',
  consentSms: 'Khi nhập số điện thoại và nhấn {button}, bạn đồng ý nhận một mật mã dùng một lần qua SMS từ ohACCESS để vào open house này. Có thể áp dụng cước phí tin nhắn và dữ liệu. Trả lời STOP để ngừng nhận, HELP để được trợ giúp.',
  consentWhatsApp: 'Khi nhập số điện thoại và nhấn {button}, bạn đồng ý nhận một mật mã dùng một lần từ ohACCESS qua WhatsApp để vào open house này. Có thể áp dụng cước phí tin nhắn và dữ liệu.',
  ...
  sentBody1WhatsApp: 'Mật mã đã được gửi cho bạn qua WhatsApp, kèm mật mã dự phòng gửi đến email của bạn.',
  checkWhatsApp: '✓ Mật mã đã được gửi cho bạn qua WhatsApp.',
  ...
  feedbackNudge: 'Sau khi tham quan: đánh giá ngôi nhà này',
  agreementTitle: 'Một bước nữa trước khi tham quan',
  agreementIntro: 'Chủ trì cần bạn xem và ký các tài liệu sau trước khi vào. Chỉ mất khoảng 20 giây, và bản đã ký sẽ được gửi đến email của bạn. Nếu bạn chọn không ký, bạn sẽ không thể tham quan bất động sản hôm nay.',
...
const zh: RegisterStrings = {
  ...
  requestBtnName: '获取暗号',
  submitting: '正在发送您的暗号...',
  consentSms: '输入您的电话号码并点击{button}，即表示您同意接收 ohACCESS 发送的一次性短信暗号，用于进入本次开放看房。可能会产生短信和流量费用。回复 STOP 退订，回复 HELP 获取帮助。',
  consentWhatsApp: '输入您的电话号码并点击{button}，即表示您同意通过 WhatsApp 接收 ohACCESS 发送的一次性暗号，用于进入本次开放看房。可能会产生短信和流量费用。',
  agreePrefix: '您还同意 ',
  ...
  sentBody1WhatsApp: '暗号已通过 WhatsApp 发送给您，备用暗号已发送到您的邮箱。',
  checkWhatsApp: '✓ 暗号已通过 WhatsApp 发送给您。',
  ...
  feedbackNudge: '参观后：为这套房打分',
  agreementTitle: '参观前还差一步',
  agreementIntro: '进入前，接待人员需要您查看并签署以下文件。大约只需 20 秒，签署后的副本会发送到您的邮箱。如果您选择不签署，今天将无法参观该房产。',
...
const ko: RegisterStrings = {
  ...
  errPhone: '유효한 휴대폰 번호를 입력해 주세요',
  errTimeline: '구입 예정 시기를 선택해 주세요',
  errSubmit: '문제가 발생했습니다. 다시 시도해 주세요.',
  requestBtn: '암호 요청 →',
  requestBtnName: '암호 요청',
  submitting: '코드를 보내는 중...',
  consentSms: '전화번호를 입력하고 {button} 버튼을 누르면, 이 오픈하우스 입장을 위한 일회용 SMS 암호를 ohACCESS로부터 받는 데 동의하는 것입니다. 메시지 및 데이터 요금이 부과될 수 있습니다. 수신 거부는 STOP, 도움말은 HELP를 회신하세요.',
  consentWhatsApp: '전화번호를 입력하고 {button} 버튼을 누르면, 이 오픈하우스 입장을 위한 일회용 암호를 ohACCESS로부터 WhatsApp으로 받는 데 동의하는 것입니다. 메시지 및 데이터 요금이 부과될 수 있습니다.',
  agreePrefix: '또한 ',
  ...
  sentBody1WhatsApp: '암호가 WhatsApp으로 전송되었고, 예비 암호가 이메일로 전송되었습니다.',
  checkWhatsApp: '✓ 암호가 WhatsApp으로 전송되었습니다.',
  ...
  feedbackNudge: '투어 후: 이 집을 평가해 주세요',
  agreementTitle: '투어 전 마지막 한 단계',
  agreementIntro: '입장 전에 호스트가 아래 문서를 확인하고 서명해 주시길 요청합니다. 약 20초면 되며, 서명된 사본이 이메일로 전송됩니다. 서명하지 않으시면 오늘은 매물을 둘러보실 수 없습니다.',
...
const hi: RegisterStrings = {
  ...
  errPhone: 'कृपया मान्य मोबाइल नंबर दर्ज करें',
  errTimeline: 'कृपया समय-सीमा चुनें',
  errSubmit: 'कुछ गलत हो गया। कृपया फिर से प्रयास करें।',
  requestBtn: 'कोडवर्ड प्राप्त करें →',
  requestBtnName: 'कोडवर्ड प्राप्त करें',
  submitting: 'आपका कोड भेजा जा रहा है...',
  consentSms: 'अपना नंबर दर्ज करके और {button} पर टैप करके, आप इस ओपन हाउस में प्रवेश के लिए ohACCESS से एक बार का SMS कोडवर्ड प्राप्त करने के लिए सहमत होते हैं। संदेश और डेटा दरें लागू हो सकती हैं। ऑप्ट-आउट के लिए STOP, सहायता के लिए HELP लिखकर जवाब दें।',
  consentWhatsApp: 'अपना नंबर दर्ज करके और {button} पर टैप करके, आप इस ओपन हाउस में प्रवेश के लिए ohACCESS से WhatsApp पर एक बार का कोडवर्ड प्राप्त करने के लिए सहमत होते हैं। संदेश और डेटा दरें लागू हो सकती हैं।',
  agreePrefix: 'आप ',
  ...
  sentBody1WhatsApp: 'कोडवर्ड आपको WhatsApp पर भेज दिया गया है, और बैकअप कोडवर्ड आपके ईमेल पर भेजा गया है।',
  checkWhatsApp: '✓ कोडवर्ड आपको WhatsApp पर भेज दिया गया है।',
  ...
  feedbackNudge: 'दौरे के बाद: इस घर को रेट करें',
  agreementTitle: 'दौरे से पहले एक और कदम',
  agreementIntro: 'प्रवेश से पहले होस्ट चाहते हैं कि आप नीचे दिए दस्तावेज़ देखें और हस्ताक्षर करें। इसमें लगभग 20 सेकंड लगते हैं, और हस्ताक्षरित प्रति आपके ईमेल पर भेज दी जाती है। यदि आप हस्ताक्षर नहीं करना चाहते, तो आज आप प्रॉपर्टी का दौरा नहीं कर पाएँगे।',
...
const zhHant: RegisterStrings = {
  ...
  requestBtnName: '取得暗號',
  submitting: '正在傳送您的暗號...',
  consentSms: '輸入您的電話號碼並點擊{button}，即表示您同意接收 ohACCESS 傳送的一次性簡訊暗號，用於進入本次開放看房。可能會產生簡訊和數據費用。回覆 STOP 退訂，回覆 HELP 取得協助。',
  consentWhatsApp: '輸入您的電話號碼並點擊{button}，即表示您同意透過 WhatsApp 接收 ohACCESS 傳送的一次性暗號，用於進入本次開放看房。可能會產生簡訊和數據費用。',
  agreePrefix: '您還同意 ',
  ...
  sentBody1WhatsApp: '暗號已透過 WhatsApp 傳送給您，備用暗號已傳送到您的信箱。',
  checkWhatsApp: '✓ 暗號已透過 WhatsApp 傳送給您。',
  ...
  feedbackNudge: '參觀後：為這間房屋評分',
  agreementTitle: '參觀前還差一步',
  agreementIntro: '進入前，接待人員需要您查看並簽署以下文件。大約只需 20 秒，簽署後的副本會寄到您的信箱。如果您選擇不簽署，今天將無法參觀該房產。',
  agreementDocsLabel: '待查看的文件',
  agreementView: '閱讀文件',
...
const fr: RegisterStrings = {
  ...
  errPhone: 'Veuillez saisir un numéro de mobile valide',
  errTimeline: "Veuillez sélectionner un délai d'achat",
  errSubmit: "Une erreur s'est produite. Veuillez réessayer.",
  requestBtn: "Demander le mot de code →",
  requestBtnName: "Demander le mot de code",
  submitting: "Envoi de votre code...",
  consentSms: "En saisissant votre numéro et en appuyant sur {button}, vous acceptez de recevoir un mot de code à usage unique par SMS d'ohACCESS pour entrer dans ces portes ouvertes. Des frais de message et de données peuvent s'appliquer. Répondez STOP pour vous désabonner, HELP pour de l'aide.",
  consentWhatsApp: 'En saisissant votre numéro et en appuyant sur {button}, vous acceptez de recevoir un mot de code à usage unique d\'ohACCESS par WhatsApp pour entrer dans ces portes ouvertes. Des frais de message et de données peuvent s\'appliquer.',
  ...
  sentBody1WhatsApp: 'Votre mot de code vous a été envoyé sur WhatsApp, avec un mot de code de secours envoyé par e-mail.',
  checkWhatsApp: '✓ Le mot de code vous a été envoyé sur WhatsApp.',
  ...
  feedbackNudge: 'Après votre visite : évaluez cette maison',
  agreementTitle: 'Une dernière étape avant votre visite',
  agreementIntro: "L'hôte vous demande de consulter et de signer les documents suivants avant d'entrer. Cela prend environ 20 secondes, et une copie signée vous est envoyée par e-mail. Si vous choisissez de ne pas signer, vous ne pourrez pas visiter la propriété aujourd'hui.",
...
const de: RegisterStrings = {
  ...
  errPhone: 'Bitte geben Sie eine gültige Mobilnummer ein',
  errTimeline: 'Bitte wählen Sie einen Kaufzeitraum',
  errSubmit: 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.',
  requestBtn: 'Codewort anfordern →',
  requestBtnName: 'Codewort anfordern',
  submitting: 'Ihr Code wird gesendet...',
  consentSms: 'Indem Sie Ihre Nummer eingeben und auf {button} tippen, stimmen Sie zu, ein einmaliges SMS-Codewort von ohACCESS zu erhalten, um diesen Tag der offenen Tür zu betreten. Es können Nachrichten- und Datengebühren anfallen. Antworten Sie mit STOP zum Abmelden, HELP für Hilfe.',
  consentWhatsApp: 'Indem Sie Ihre Nummer eingeben und auf {button} tippen, stimmen Sie zu, ein einmaliges Codewort von ohACCESS per WhatsApp zu erhalten, um diesen Tag der offenen Tür zu betreten. Es können Nachrichten- und Datengebühren anfallen.',
  ...
  sentBody1WhatsApp: 'Ihr Codewort wurde Ihnen per WhatsApp gesendet, ein Ersatz-Codewort an Ihre E-Mail.',
  checkWhatsApp: '✓ Das Codewort wurde Ihnen per WhatsApp gesendet.',
  ...
  feedbackNudge: 'Nach der Besichtigung: Bewerten Sie dieses Haus',
  agreementTitle: 'Ein letzter Schritt vor Ihrer Besichtigung',
  agreementIntro: 'Der Gastgeber bittet Sie, vor dem Betreten die folgenden Dokumente zu prüfen und zu unterschreiben. Das dauert etwa 20 Sekunden; eine unterschriebene Kopie erhalten Sie per E-Mail. Wenn Sie nicht unterschreiben möchten, können Sie die Immobilie heute nicht besichtigen.',
...
const it: RegisterStrings = {
  ...
  errPhone: 'Inserisci un numero di cellulare valido',
  errTimeline: "Seleziona una tempistica di acquisto",
  errSubmit: "Qualcosa è andato storto. Riprova.",
  requestBtn: "Richiedi la parola in codice →",
  requestBtnName: "Richiedi la parola in codice",
  submitting: "Invio del codice...",
  consentSms: "Inserendo il tuo numero e toccando {button}, accetti di ricevere una parola in codice monouso via SMS da ohACCESS per entrare in questa casa aperta. Possono essere applicate tariffe per messaggi e dati. Rispondi STOP per annullare, HELP per assistenza.",
  consentWhatsApp: 'Inserendo il tuo numero e toccando {button}, accetti di ricevere una parola in codice monouso da ohACCESS via WhatsApp per entrare in questa casa aperta. Possono essere applicate tariffe per messaggi e dati.',
  ...
  sentBody1WhatsApp: 'La tua parola in codice ti è stata inviata su WhatsApp, con una parola in codice di riserva inviata via email.',
  checkWhatsApp: '✓ La parola in codice ti è stata inviata su WhatsApp.',
  ...
  feedbackNudge: 'Dopo la visita: valuta questa casa',
  agreementTitle: 'Un ultimo passaggio prima della visita',
  agreementIntro: "Prima di entrare, l'ospite ti chiede di leggere e firmare i seguenti documenti. Richiede circa 20 secondi e una copia firmata ti viene inviata via email. Se scegli di non firmare, oggi non potrai visitare l'immobile.",
...
const el: RegisterStrings = {
  ...
  errPhone: 'Παρακαλώ εισαγάγετε έγκυρο αριθμό κινητού',
  errTimeline: 'Παρακαλώ επιλέξτε χρονοδιάγραμμα αγοράς',
  errSubmit: 'Κάτι πήγε στραβά. Παρακαλώ δοκιμάστε ξανά.',
  requestBtn: 'Ζητήστε κωδική λέξη →',
  requestBtnName: 'Ζητήστε κωδική λέξη',
  submitting: 'Αποστολή του κωδικού σας...',
  consentSms: 'Εισάγοντας τον αριθμό σας και πατώντας {button}, συμφωνείτε να λάβετε μια εφάπαξ κωδική λέξη μέσω SMS από την ohACCESS για να εισέλθετε σε αυτό το ανοιχτό σπίτι. Ενδέχεται να ισχύουν χρεώσεις μηνυμάτων και δεδομένων. Απαντήστε STOP για διαγραφή, HELP για βοήθεια.',
  consentWhatsApp: 'Εισάγοντας τον αριθμό σας και πατώντας {button}, συμφωνείτε να λάβετε μια εφάπαξ κωδική λέξη από την ohACCESS μέσω WhatsApp για να εισέλθετε σε αυτό το ανοιχτό σπίτι. Ενδέχεται να ισχύουν χρεώσεις μηνυμάτων και δεδομένων.',
  ...
  sentBody1WhatsApp: 'Η κωδική λέξη σας στάλθηκε μέσω WhatsApp, με μια εφεδρική κωδική λέξη να στέλνεται στο email σας.',
  checkWhatsApp: '✓ Η κωδική λέξη στάλθηκε μέσω WhatsApp.',
  ...
  feedbackNudge: 'Μετά την περιήγηση: βαθμολογήστε αυτό το σπίτι',
  agreementTitle: 'Ένα ακόμη βήμα πριν από την ξενάγηση',
  agreementIntro: 'Πριν εισέλθετε, ο οικοδεσπότης σάς ζητά να διαβάσετε και να υπογράψετε τα παρακάτω έγγραφα. Διαρκεί περίπου 20 δευτερόλεπτα και ένα υπογεγραμμένο αντίγραφο σας αποστέλλεται με email. Εάν επιλέξετε να μην υπογράψετε, δεν θα μπορέσετε να επισκεφθείτε το ακίνητο σήμερα.',
...
const pl: RegisterStrings = {
  ...
  errPhone: 'Podaj prawidłowy numer telefonu komórkowego',
  errTimeline: 'Wybierz planowany termin zakupu',
  errSubmit: 'Coś poszło nie tak. Spróbuj ponownie.',
  requestBtn: 'Poproś o hasło dostępu →',
  requestBtnName: 'Poproś o hasło dostępu',
  submitting: 'Wysyłanie kodu...',
  consentSms: 'Wpisując swój numer i klikając {button}, zgadzasz się na otrzymanie jednorazowego hasła dostępu SMS od ohACCESS, aby wejść na ten dzień otwarty. Mogą obowiązywać opłaty za wiadomości i dane. Odpowiedz STOP, aby zrezygnować, HELP, aby uzyskać pomoc.',
  consentWhatsApp: 'Wpisując swój numer i klikając {button}, zgadzasz się na otrzymanie jednorazowego hasła dostępu od ohACCESS przez WhatsApp, aby wejść na ten dzień otwarty. Mogą obowiązywać opłaty za wiadomości i dane.',
  ...
  sentBody1WhatsApp: 'Twoje hasło dostępu zostało wysłane przez WhatsApp, a zapasowe hasło na e-mail.',
  checkWhatsApp: '✓ Hasło dostępu zostało wysłane przez WhatsApp.',
  ...
  feedbackNudge: 'Po zwiedzaniu: oceń ten dom',
  agreementTitle: 'Jeszcze jeden krok przed zwiedzaniem',
  agreementIntro: 'Przed wejściem gospodarz prosi o zapoznanie się z poniższymi dokumentami i ich podpisanie. Zajmuje to około 20 sekund, a podpisana kopia zostanie wysłana na Twój e-mail. Jeśli zdecydujesz się nie podpisywać, zwiedzenie nieruchomości dziś nie będzie możliwe.',
...
const ru: RegisterStrings = {
  ...
  errPhone: 'Пожалуйста, введите действующий номер мобильного телефона',
  errTimeline: 'Пожалуйста, выберите срок покупки',
  errSubmit: 'Что-то пошло не так. Пожалуйста, попробуйте снова.',
  requestBtn: 'Запросить кодовое слово →',
  requestBtnName: 'Запросить кодовое слово',
  submitting: 'Отправка вашего кода...',
  consentSms: 'Вводя свой номер и нажимая {button}, вы соглашаетесь получить одноразовое кодовое слово по SMS от ohACCESS для входа на этот день открытых дверей. Могут применяться тарифы за сообщения и данные. Ответьте STOP для отписки, HELP для помощи.',
  consentWhatsApp: 'Вводя свой номер и нажимая {button}, вы соглашаетесь получить одноразовое кодовое слово от ohACCESS через WhatsApp для входа на этот день открытых дверей. Могут применяться тарифы за сообщения и данные.',
  ...
  sentBody1WhatsApp: 'Ваше кодовое слово отправлено вам в WhatsApp, а резервное кодовое слово — на эл. почту.',
  checkWhatsApp: '✓ Кодовое слово отправлено вам в WhatsApp.',
  ...
  feedbackNudge: 'После осмотра: оцените этот дом',
  agreementTitle: 'Ещё один шаг перед осмотром',
  agreementIntro: 'Перед входом принимающий агент просит вас ознакомиться со следующими документами и подписать их. Это занимает около 20 секунд, подписанная копия придёт вам на эл. почту. Если вы решите не подписывать, сегодня вы не сможете осмотреть объект.',
...
const pt: RegisterStrings = {
  ...
  errPhone: 'Digite um número de celular válido',
  errTimeline: 'Selecione um prazo de compra',
  errSubmit: 'Algo deu errado. Tente novamente.',
  requestBtn: 'Solicitar palavra-código →',
  requestBtnName: 'Solicitar palavra-código',
  submitting: 'Enviando seu código...',
  consentSms: 'Ao inserir seu número e tocar em {button}, você concorda em receber uma palavra-código única por SMS da ohACCESS para entrar nesta casa aberta. Podem ser aplicadas tarifas de mensagens e dados. Responda STOP para cancelar, HELP para ajuda.',
  consentWhatsApp: 'Ao inserir seu número e tocar em {button}, você concorda em receber uma palavra-código única da ohACCESS pelo WhatsApp para entrar nesta casa aberta. Podem ser aplicadas tarifas de mensagens e dados.',
  ...
  sentBody1WhatsApp: 'Sua palavra-código foi enviada para você pelo WhatsApp, com uma palavra-código reserva enviada para o seu e-mail.',
  checkWhatsApp: '✓ A palavra-código foi enviada pelo WhatsApp.',
  ...
  feedbackNudge: 'Depois da visita: avalie esta casa',
  agreementTitle: 'Mais um passo antes da visita',
  agreementIntro: 'Antes de entrar, o anfitrião pede que você leia e assine os documentos a seguir. Leva cerca de 20 segundos, e uma cópia assinada é enviada para o seu e-mail. Se você optar por não assinar, não poderá visitar o imóvel hoje.',
...
const tl: RegisterStrings = {
  ...
  errPhone: 'Pakilagay ang wastong numero ng mobile',
  errTimeline: 'Pumili ng takdang panahon ng pagbili',
  errSubmit: 'May nangyaring mali. Pakisubukang muli.',
  requestBtn: 'Humiling ng codeword →',
  requestBtnName: 'Humiling ng codeword',
  submitting: 'Ipinapadala ang iyong code...',
  consentSms: 'Sa paglalagay ng iyong numero at pag-tap sa {button}, sumasang-ayon kang tumanggap ng isang beses na SMS codeword mula sa ohACCESS para makapasok sa open house na ito. Maaaring may bayad sa mensahe at data. Sumagot ng STOP para mag-opt out, HELP para sa tulong.',
  consentWhatsApp: 'Sa paglalagay ng iyong numero at pag-tap sa {button}, sumasang-ayon kang tumanggap ng isang beses na codeword mula sa ohACCESS sa pamamagitan ng WhatsApp para makapasok sa open house na ito. Maaaring may bayad sa mensahe at data.',
  ...
  sentBody1WhatsApp: 'Ipinadala ang iyong codeword sa iyo sa WhatsApp, may backup na codeword na ipinadala sa iyong email.',
  checkWhatsApp: '✓ Ipinadala ang codeword sa iyo sa WhatsApp.',
  ...
  feedbackNudge: 'Pagkatapos ng iyong tour: i-rate ang bahay na ito',
  agreementTitle: 'Isa pang hakbang bago ang iyong pagsilip',
  agreementIntro: 'Bago pumasok, hinihiling ng host na basahin at pirmahan mo ang mga sumusunod na dokumento. Aabutin lang ito ng mga 20 segundo, at ipapadala sa email mo ang pirmadong kopya. Kung pipiliin mong hindi pumirma, hindi ka makakapag-tour ng property ngayong araw.',
...
const pa: RegisterStrings = {
  ...
  errPhone: 'ਕਿਰਪਾ ਕਰਕੇ ਵੈਧ ਮੋਬਾਈਲ ਨੰਬਰ ਦਰਜ ਕਰੋ',
  errTimeline: 'ਕਿਰਪਾ ਕਰਕੇ ਖਰੀਦਣ ਦੀ ਸਮਾਂ-ਸੀਮਾ ਚੁਣੋ',
  errSubmit: 'ਕੁਝ ਗਲਤ ਹੋ ਗਿਆ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
  requestBtn: 'ਕੋਡਵਰਡ ਮੰਗੋ →',
  requestBtnName: 'ਕੋਡਵਰਡ ਮੰਗੋ',
  submitting: 'ਤੁਹਾਡਾ ਕੋਡ ਭੇਜਿਆ ਜਾ ਰਿਹਾ ਹੈ...',
  consentSms: 'ਆਪਣਾ ਨੰਬਰ ਦਰਜ ਕਰਕੇ ਅਤੇ {button} ਦਬਾ ਕੇ, ਤੁਸੀਂ ਇਸ ਓਪਨ ਹਾਊਸ ਵਿੱਚ ਦਾਖਲ ਹੋਣ ਲਈ ohACCESS ਤੋਂ ਇੱਕ ਵਾਰੀ SMS ਕੋਡਵਰਡ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ ਸਹਿਮਤ ਹੁੰਦੇ ਹੋ। ਸੁਨੇਹਾ ਅਤੇ ਡਾਟਾ ਦਰਾਂ ਲਾਗੂ ਹੋ ਸਕਦੀਆਂ ਹਨ। ਬੰਦ ਕਰਨ ਲਈ STOP, ਮਦਦ ਲਈ HELP ਲਿਖ ਕੇ ਜਵਾਬ ਦਿਓ।',
  consentWhatsApp: 'ਆਪਣਾ ਨੰਬਰ ਦਰਜ ਕਰਕੇ ਅਤੇ {button} ਦਬਾ ਕੇ, ਤੁਸੀਂ ਇਸ ਓਪਨ ਹਾਊਸ ਵਿੱਚ ਦਾਖਲ ਹੋਣ ਲਈ ohACCESS ਤੋਂ WhatsApp ਰਾਹੀਂ ਇੱਕ ਵਾਰੀ ਕੋਡਵਰਡ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ ਸਹਿਮਤ ਹੁੰਦੇ ਹੋ। ਸੁਨੇਹਾ ਅਤੇ ਡਾਟਾ ਦਰਾਂ ਲਾਗੂ ਹੋ ਸਕਦੀਆਂ ਹਨ।',
  agreePrefix: 'ਤੁਸੀਂ ',
  ...
  sentBody1WhatsApp: 'ਤੁਹਾਡਾ ਕੋਡਵਰਡ ਤੁਹਾਨੂੰ WhatsApp ਉੱਤੇ ਭੇਜ ਦਿੱਤਾ ਗਿਆ ਹੈ, ਅਤੇ ਬੈਕਅੱਪ ਕੋਡਵਰਡ ਤੁਹਾਡੀ ਈਮੇਲ ਉੱਤੇ ਭੇਜਿਆ ਗਿਆ ਹੈ।',
  checkWhatsApp: '✓ ਕੋਡਵਰਡ ਤੁਹਾਨੂੰ WhatsApp ਉੱਤੇ ਭੇਜ ਦਿੱਤਾ ਗਿਆ ਹੈ।',
  ...
  feedbackNudge: 'ਦੌਰੇ ਤੋਂ ਬਾਅਦ: ਇਸ ਘਰ ਨੂੰ ਰੇਟ ਕਰੋ',
  agreementTitle: 'ਦੌਰੇ ਤੋਂ ਪਹਿਲਾਂ ਇੱਕ ਹੋਰ ਕਦਮ',
  agreementIntro: 'ਅੰਦਰ ਜਾਣ ਤੋਂ ਪਹਿਲਾਂ, ਮੇਜ਼ਬਾਨ ਚਾਹੁੰਦਾ ਹੈ ਕਿ ਤੁਸੀਂ ਹੇਠਾਂ ਦਿੱਤੇ ਦਸਤਾਵੇਜ਼ ਵੇਖੋ ਅਤੇ ਦਸਤਖਤ ਕਰੋ। ਇਸ ਵਿੱਚ ਲਗਭਗ 20 ਸਕਿੰਟ ਲੱਗਦੇ ਹਨ, ਅਤੇ ਦਸਤਖਤ ਕੀਤੀ ਕਾਪੀ ਤੁਹਾਡੀ ਈਮੇਲ ਉੱਤੇ ਭੇਜ ਦਿੱਤੀ ਜਾਂਦੀ ਹੈ। ਜੇ ਤੁਸੀਂ ਦਸਤਖਤ ਨਾ ਕਰਨ ਦੀ ਚੋਣ ਕਰਦੇ ਹੋ, ਤਾਂ ਅੱਜ ਤੁਸੀਂ ਪ੍ਰਾਪਰਟੀ ਨਹੀਂ ਵੇਖ ਸਕੋਗੇ।',
