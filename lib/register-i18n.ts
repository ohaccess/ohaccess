...
const en: RegisterStrings = {
  ...
  errPhone: 'Please enter a valid U.S. phone number',
  ...
  agreeSuffix: ', and consent to be contacted by the listing agent via phone, text, and email about this and other properties.',
  englishGoverns: '',
...
const es: RegisterStrings = {
  ...
  errPhone: 'Por favor ingresa un número de teléfono válido de EE. UU.',
  ...
  agreeSuffix: ', y das tu consentimiento para que el agente del listado te contacte por teléfono, mensaje de texto y correo electrónico sobre esta y otras propiedades.',
...
const vi: RegisterStrings = {
  ...
  errPhone: 'Vui lòng nhập số điện thoại Hoa Kỳ hợp lệ',
  ...
  agreeSuffix: ', và đồng ý để chuyên viên môi giới niêm yết liên hệ với bạn qua điện thoại, tin nhắn và email về bất động sản này và các bất động sản khác.',
...
const zh: RegisterStrings = {
  ...
  agreeSuffix: '，并同意挂牌经纪人通过电话、短信和电子邮件就本房产及其他房产与您联系。',
...
const ko: RegisterStrings = {
  ...
  agreeSuffix: '에 동의하며, 리스팅 에이전트가 이 매물 및 다른 매물에 관해 전화, 문자, 이메일로 연락하는 데 동의합니다.',
...
const hi: RegisterStrings = {
  ...
  errPhone: 'कृपया मान्य अमेरिकी फ़ोन नंबर दर्ज करें',
  ...
  agreeSuffix: ' से भी सहमत होते हैं, और इस बात की सहमति देते हैं कि लिस्टिंग एजेंट इस और अन्य संपत्तियों के बारे में आपसे फ़ोन, टेक्स्ट और ईमेल द्वारा संपर्क कर सकते हैं।',
