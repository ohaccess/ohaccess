...
export function buildFirstOpenHouseEmail(o: {
  ...
  const bodyHtml = `
    ...
    <div style="font-size:14px;line-height:1.7;margin-top:16px;">
      ...
      close. Your first <strong>25 sign-ins are free</strong>, which is one or two good open houses to see
      the difference.
    </div>
...
export function buildReferralEmail(o: {
  ...
  return {
    subject: 'Give a colleague ohACCESS and earn a free month',
    html: shell({
