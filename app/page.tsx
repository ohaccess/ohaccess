  ...
  return (
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#ffffff', color: '#1d1d1f', overflowX: 'hidden' }}>
      ...
      <footer style={{ background: '#111', padding: '40px 24px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)' }}>© 2026 ohACCESS. All rights reserved. · <span style={{ color: 'rgba(255,255,255,0.55)', fontWeight: '600' }}>Patent Pending</span></div>
      </footer>
    </main>
  )
}