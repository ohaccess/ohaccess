        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>
          ...
          <Section title="7. Acceptable Use">
            ...
            <ul style={{ paddingLeft: '24px', marginTop: '10px' }}>
              <li style={{ marginBottom: '6px' }}>Upload, import, paste, or otherwise introduce into the Service any Visitor contact information (name, phone number, email address, or other personal identifier) that was not collected through an ohACCESS-powered Visitor registration form. The Service is designed exclusively for in-person, opt-in open-house registrations; introducing externally sourced contacts misrepresents consent, violates these Terms, and is grounds for immediate termination;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service to send messages unrelated to real estate services or follow-up regarding the specific property at which the Visitor registered;</li>
              <li style={{ marginBottom: '6px' }}>Send any further communication (SMS, email, call, or otherwise) to a Visitor after they have opted out via &quot;STOP&quot; or equivalent SMS reply, email unsubscribe, written request, or verbal request, regardless of channel — including by re-importing the opted-out Visitor&apos;s number into a different ohACCESS account, agent, or brokerage you control;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service in violation of the Telephone Consumer Protection Act (TCPA), the CAN-SPAM Act, the FTC Telemarketing Sales Rule (TSR), state Do Not Call laws, state mini-TCPA statutes (including but not limited to the Florida Telephone Solicitation Act, Washington CEMA, and Oklahoma TCPA), or any other applicable telecommunications, marketing, or consumer protection law;</li>
              <li style={{ marginBottom: '6px' }}>Perform reverse-lookup, append, enrichment, skip-tracing, or any similar process on Visitor contact data using third-party services or databases not authorized by these Terms;</li>
              <li style={{ marginBottom: '6px' }}>Share, sell, rent, license, sublicense, or transfer Visitor data collected through the Service to any third party (including affiliated brokerages, loan officers, title companies, or co-marketing partners) except (a) as expressly authorized by the Visitor through the ohACCESS registration consent flow, or (b) as required by law;</li>
              <li style={{ marginBottom: '6px' }}>Use Visitor data collected through the Service for any purpose not disclosed to the Visitor at the time of registration, including but not limited to lead-list resale, broker referral schemes, mortgage cross-marketing, or training of artificial intelligence or machine learning systems;</li>
              <li style={{ marginBottom: '6px' }}>Reverse engineer, decompile, scrape, web-scrape, or attempt to extract source code, data structures, or proprietary algorithms from the Service;</li>
          ...
          <Section title="8. TCPA, CAN-SPAM & Marketing Compliance">
            ...
            <p style={{ marginTop: '10px' }}><strong>8.3 Consent Records.</strong> ohACCESS provides the Visitor consent capture flow and retains consent records on your behalf for the duration of your account. Upon termination, we will provide consent records to you upon written request for a period of up to thirty (30) days. You are responsible for retaining your own copies of consent records as may be required by law. ohACCESS&apos;s consent records reflect what the Visitor submitted; they do not constitute a representation by ohACCESS that the submission was accurate or made by the actual owner of the contact information.</p>
            <p style={{ marginTop: '10px' }}><strong>8.4 Opt-Out Handling.</strong> The Service honors &quot;STOP,&quot; &quot;QUIT,&quot; &quot;CANCEL,&quot; &quot;UNSUBSCRIBE,&quot; and &quot;END&quot; SMS replies at the carrier level. You are responsible for (a) honoring opt-out requests received through any other channel (email reply, phone call, in-person request, written request, or social media), (b) ensuring no further communications are sent to opted-out Visitors through ohACCESS or any other means under your control, including via re-entry of the opted-out number into a different account, agent profile, or brokerage roster you control, and (c) maintaining your own suppression list of opt-outs received outside the Service.</p>
          ...
          <Section title="14. Indemnification">
            <p style={{ textTransform: 'uppercase' as const }}><strong>14.1 SUBSCRIBER INDEMNITY.</strong> YOU WILL DEFEND, INDEMNIFY, AND HOLD HARMLESS OHACCESS, ITS AFFILIATES, AND THEIR RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES, CONTRACTORS, AND AGENTS FROM AND AGAINST ANY AND ALL THIRD-PARTY CLAIMS, DAMAGES, LOSSES, LIABILITIES, COSTS, AND EXPENSES (INCLUDING REASONABLE ATTORNEYS&apos; FEES, EXPERT FEES, AND COURT COSTS) ARISING OUT OF OR RELATED TO:</p>
            <ul style={{ paddingLeft: '24px', marginTop: '10px' }}>
              <li style={{ marginBottom: '6px' }}>(a) your use of the Service in violation of these Terms or any applicable law, regulation, or rule;</li>
              <li style={{ marginBottom: '6px' }}>(b) Subscriber Data, including any claim that Subscriber Data infringes, misappropriates, or violates a third party&apos;s intellectual property, privacy, publicity, or contractual rights;</li>
              <li style={{ marginBottom: '6px' }}>(c) any message sent by you, or on your behalf, through the Service, including all claims under the Telephone Consumer Protection Act (47 U.S.C. § 227 and 47 C.F.R. § 64.1200), the CAN-SPAM Act (15 U.S.C. §§ 7701–7713), the FTC Telemarketing Sales Rule (16 C.F.R. Part 310), federal or state Do Not Call rules, state mini-TCPA or telephone solicitation statutes (including but not limited to the Florida Telephone Solicitation Act, Washington CEMA, and Oklahoma TCPA), the Fair Housing Act, the Equal Credit Opportunity Act, and any analogous federal, state, or local law;</li>
              <li style={{ marginBottom: '6px' }}>(d) any claim by a person who received a message you sent through the Service alleging they did not consent, did not own the phone number or email address used, or are not the Visitor who submitted the registration — regardless of whether the inaccuracy originated from Visitor input;</li>
              <li style={{ marginBottom: '6px' }}>(e) any breach of Section 7 (Acceptable Use) or Section 8 (Marketing Compliance);</li>
              <li style={{ marginBottom: '6px' }}>(f) any data subject request, regulatory inquiry, or class action arising from your handling of Visitor data; or</li>
              <li>(g) your gross negligence, willful misconduct, or fraud.</li>
            </ul>
