    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#ffffff', color: '#1d1d1f', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#6e6e73' }}>For real estate agents, teams, and brokerages who hold an ohACCESS account · Effective Date: June 1, 2026 · ohaccess.com</div>
        </div>
        ...
        <div style={{ background: '#fffbeb', border: '1px solid #f59e0b', borderRadius: '10px', padding: '14px 18px', marginBottom: '40px', fontSize: '13px', color: '#78350f', lineHeight: '1.6' }}>
          <strong>Notice:</strong> This is a v1 draft pending review by a qualified Texas attorney. ohACCESS subscribers should consider these terms binding upon acceptance; however, certain provisions may be refined following legal review.
        </div>

        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>

          <Section title="1. Acceptance of Terms">
            These Subscriber Terms of Service (&quot;Terms&quot;) form a binding agreement between you (&quot;Subscriber,&quot; &quot;you,&quot; or &quot;your&quot;) and ohACCESS, LLC, a Texas limited liability company (&quot;ohACCESS,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). By creating an ohACCESS account, accessing the ohACCESS platform, or using any feature of the Service in any capacity other than as a Visitor registering at an open house, you represent that you have read, understood, and agreed to be bound by these Terms. If you are entering into these Terms on behalf of a company, brokerage, team, or other legal entity, you represent that you have the authority to bind that entity to these Terms, and the terms &quot;Subscriber&quot; and &quot;you&quot; refer to that entity. If you do not agree to these Terms, you may not access or use the Service.
          </Section>
          ...
          <Section title="2. Definitions">
            ...
            <p style={{ marginTop: '10px' }}><strong>&quot;Visitor&quot;</strong> means an individual who registers at an open house through an ohACCESS-powered registration form. Visitor relationships with ohACCESS are governed by the separate <a href="/terms" style={{ color: '#0071e3', textDecoration: 'underline' }}>Visitor Terms of Service</a>.</p>
          ...
          <Section title="4. Plans, Subscriptions, and Billing">
            ...
            <p style={{ marginTop: '10px' }}><strong>4.6 Cancellation.</strong> You may cancel your Subscription at any time through your account settings or by emailing support@ohaccess.com. Cancellation takes effect at the end of your then-current paid billing cycle; you retain access to paid features through that date.</p>
            ...
            <p style={{ marginTop: '10px' }}><strong>4.8 Taxes.</strong> Fees are exclusive of any applicable taxes, levies, or duties. You are responsible for paying any taxes assessed in connection with your Subscription, except for taxes based on ohACCESS&apos;s net income.</p>
          </Section>

          <Section title="5. License to Use the Service">
            <p>Subject to your compliance with these Terms and timely payment of all fees, ohACCESS grants you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to access and use the Service during the term of your Subscription solely for your internal business purposes as a real estate professional, team, or brokerage. All rights not expressly granted in these Terms are reserved by ohACCESS.</p>
          </Section>
          ...
          <Section title="7. Acceptable Use">
            ...
            <ul style={{ paddingLeft: '24px', marginTop: '10px' }}>
              <li style={{ marginBottom: '6px' }}>Upload or import contacts that did not register through an ohACCESS-powered form (the Service is designed for verified open-house registrations only; importing outside contacts misrepresents consent and is prohibited);</li>
              <li style={{ marginBottom: '6px' }}>Use the Service to send messages unrelated to real estate services or follow-up regarding the property at which the Visitor registered;</li>
              <li style={{ marginBottom: '6px' }}>Send messages to any Visitor after they have opted out via &quot;STOP&quot; SMS reply, email unsubscribe, or written request;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service in violation of the Telephone Consumer Protection Act (TCPA), CAN-SPAM Act, FTC regulations, state Do Not Call laws, or any other applicable telecommunications, marketing, or consumer protection law;</li>
              <li style={{ marginBottom: '6px' }}>Share, sell, rent, or transfer Visitor data collected through the Service to any third party except as expressly permitted by the Visitor or required by law;</li>
              <li style={{ marginBottom: '6px' }}>Reverse engineer, decompile, scrape, or attempt to extract source code from the Service;</li>
              <li style={{ marginBottom: '6px' }}>Circumvent rate limits, authentication, billing, or any other technical or contractual restriction;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service to send spam, phishing messages, malware, or any unlawful, fraudulent, defamatory, harassing, or harmful content;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service to discriminate against Visitors in violation of the Fair Housing Act or any other anti-discrimination law;</li>
              <li style={{ marginBottom: '6px' }}>Use the Service to compete with ohACCESS or build a competing product;</li>
              <li>Permit any individual other than the account holder (or, in the case of Team and Brokerage plans, properly invited team members) to access your account.</li>
            </ul>
            <p style={{ marginTop: '12px' }}>Violation of this Section 7 may result in immediate suspension or termination of your Subscriber Account without refund, in addition to any other remedies available to ohACCESS at law or in equity.</p>
          </Section>

          <Section title="8. TCPA, CAN-SPAM & Marketing Compliance">
            <p><strong>8.1 Your Responsibility.</strong> You acknowledge that you are the &quot;sender&quot; under the CAN-SPAM Act and the party initiating contact under the TCPA for all follow-up messages you send to Visitors, including messages sent through the Service. You are solely responsible for ensuring that all such communications comply with the TCPA, CAN-SPAM, the FTC&apos;s Telemarketing Sales Rule, applicable state Do Not Call laws, and any other applicable law.</p>
            <p style={{ marginTop: '10px' }}><strong>8.2 Consent Records.</strong> ohACCESS provides the Visitor consent capture flow and retains consent records on your behalf for the duration of your account. Upon termination, we will provide consent records to you upon written request for a period of up to thirty (30) days. You are responsible for retaining your own copies of consent records as may be required by law.</p>
            <p style={{ marginTop: '10px' }}><strong>8.3 Opt-Out Handling.</strong> The Service honors &quot;STOP&quot; SMS replies at the carrier level. You are responsible for honoring opt-out requests received through any other channel (email reply, phone call, written request) and for ensuring no further communications are sent to opted-out Visitors through ohACCESS or any other means.</p>
            <p style={{ marginTop: '10px' }}><strong>8.4 Indemnity for Compliance Failures.</strong> See Section 14.</p>
          </Section>
          ...
          <Section title="10. Confidentiality">
            <p>Each party may disclose to the other certain non-public information designated as confidential or that a reasonable person would understand to be confidential (&quot;Confidential Information&quot;). The receiving party will (a) use Confidential Information only to perform under these Terms, (b) protect it using at least the same degree of care it uses to protect its own confidential information of similar sensitivity (but no less than reasonable care), and (c) not disclose it to any third party except to employees, contractors, and advisors with a need to know and bound by confidentiality obligations no less protective than these. This Section does not apply to information that is publicly available, independently developed, or required to be disclosed by law.</p>
          </Section>

          <Section title="11. Intellectual Property">
            <p>ohACCESS and its licensors retain all right, title, and interest in and to the Service, including all software, designs, trademarks, logos, and content (excluding Subscriber Data). No license is granted to you except as expressly set forth in Section 5. The &quot;ohACCESS&quot; name and logo are trademarks of ohACCESS, LLC and may not be used without our prior written consent.</p>
            <p style={{ marginTop: '10px' }}>If you provide ohACCESS with any feedback, suggestions, or ideas regarding the Service, you grant ohACCESS a perpetual, irrevocable, royalty-free, worldwide license to use and incorporate that feedback into the Service without obligation to you.</p>
          </Section>

          <Section title="12. Service Availability, Modifications & Disclaimers">
            <p><strong>12.1 Availability.</strong> We will use commercially reasonable efforts to make the Service available 24/7, excluding scheduled maintenance, emergency maintenance, and circumstances beyond our reasonable control (including failures of third-party services such as Supabase, Twilio, Resend, Stripe, Vercel, or telecommunications carriers). We do not commit to any specific uptime percentage.</p>
            <p style={{ marginTop: '10px' }}><strong>12.2 SMS &amp; Email Deliverability.</strong> SMS and email delivery depends on third-party carriers and providers whose performance is outside ohACCESS&apos;s control. We do not warrant that any specific message will be delivered, delivered on time, or received without modification.</p>
            <p style={{ marginTop: '10px' }}><strong>12.3 Modifications.</strong> We may modify, add, or remove features at any time. We will provide reasonable notice of any material adverse change to the Service.</p>
            <p style={{ marginTop: '10px', textTransform: 'uppercase' as const }}><strong>12.4 DISCLAIMERS.</strong> THE SERVICE IS PROVIDED &quot;AS IS&quot; AND &quot;AS AVAILABLE,&quot; WITHOUT WARRANTIES OF ANY KIND, EXPRESS, IMPLIED, OR STATUTORY, INCLUDING WITHOUT LIMITATION WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, AND ANY WARRANTIES ARISING OUT OF COURSE OF DEALING OR USAGE OF TRADE. OHACCESS DOES NOT WARRANT THAT THE SERVICE WILL MEET YOUR REQUIREMENTS, OPERATE WITHOUT INTERRUPTION OR ERROR, OR BE FREE FROM VULNERABILITIES OR HARMFUL COMPONENTS.</p>
          </Section>

          <Section title="13. Limitation of Liability">
            <p style={{ textTransform: 'uppercase' as const }}>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL OHACCESS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR FOR ANY LOSS OF PROFITS, REVENUE, DATA, GOODWILL, OR BUSINESS OPPORTUNITY, ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICE, WHETHER BASED IN CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY, OR OTHERWISE, EVEN IF OHACCESS HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
            <p style={{ marginTop: '10px', textTransform: 'uppercase' as const }}>OHACCESS&apos;S TOTAL CUMULATIVE LIABILITY ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICE WILL NOT EXCEED THE GREATER OF (A) THE TOTAL FEES PAID BY YOU TO OHACCESS IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM, OR (B) ONE HUNDRED U.S. DOLLARS ($100).</p>
          ...
          <Section title="14. Indemnification">
            <p><strong>14.1 Subscriber Indemnity.</strong> You will defend, indemnify, and hold harmless ohACCESS, its affiliates, and their respective officers, directors, employees, and agents from and against any third-party claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys&apos; fees) arising out of or related to: (a) your use of the Service in violation of these Terms or any law; (b) Subscriber Data, including any claim that Subscriber Data infringes or violates a third party&apos;s rights; (c) your communications with Visitors, including any TCPA, CAN-SPAM, DNC, or Fair Housing Act claims; (d) any breach of Section 7 (Acceptable Use) or Section 8 (Marketing Compliance); or (e) your gross negligence or willful misconduct.</p>
            <p style={{ marginTop: '10px' }}><strong>14.2 ohACCESS Indemnity.</strong> ohACCESS will defend, indemnify, and hold harmless Subscriber from and against third-party claims alleging that the Service, as provided by ohACCESS and used in accordance with these Terms, infringes a U.S. patent, copyright, or trademark; provided that this indemnity does not apply to claims arising from (a) Subscriber Data, (b) modifications to the Service not made by ohACCESS, (c) combination of the Service with any third-party product or service, or (d) use of the Service in violation of these Terms.</p>
            <p style={{ marginTop: '10px' }}><strong>14.3 Procedure.</strong> The indemnified party must (i) promptly notify the indemnifying party of the claim, (ii) give the indemnifying party sole control of the defense and settlement, and (iii) provide reasonable cooperation at the indemnifying party&apos;s expense.</p>
          </Section>
          ...
          <Section title="15. Term & Termination">
            ...
            <p style={{ marginTop: '10px' }}><strong>15.4 Effect of Termination.</strong> Upon termination, your right to access the Service immediately ceases. Sections 4.7 (Refunds), 6 (Subscriber Data), 7 (Acceptable Use), 8 (Marketing Compliance), 10 (Confidentiality), 11 (IP), 12.4 (Disclaimers), 13 (Limitation of Liability), 14 (Indemnification), 15.4, 16, 17, 18, 19, and 20 survive termination.</p>
          </Section>

          <Section title="16. Data Retention After Termination">
            <p>Upon termination, ohACCESS will retain your Subscriber Data for thirty (30) days during which you may request export. After that period, we may delete your Subscriber Data from production systems. Visitor consent records and certain financial records may be retained for longer periods as required by law (typically up to seven years). Anonymized or aggregated data derived from Subscriber Data may be retained indefinitely.</p>
          </Section>
          ...
          <Section title="18. Governing Law & Dispute Resolution">
            ...
            <p style={{ marginTop: '10px' }}><strong>18.2 Venue.</strong> Any dispute, claim, or controversy arising out of or related to these Terms or the Service that is not subject to arbitration under Section 18.3 will be brought exclusively in the state or federal courts located in the county in Texas where ohACCESS maintains its principal place of business, and the parties consent to the personal jurisdiction of such courts.</p>
          ...
          <Section title="19. General Provisions">
            ...
            <p style={{ marginTop: '10px' }}><strong>19.5 Force Majeure.</strong> Neither party is liable for failure to perform due to causes beyond its reasonable control, including acts of God, war, terrorism, natural disaster, labor disputes, internet or telecommunications failure, or governmental action.</p>
            ...
            <p style={{ marginTop: '10px' }}><strong>19.7 Independent Contractors.</strong> The parties are independent contractors. These Terms do not create a partnership, joint venture, employment, or agency relationship.</p>
          ...
          <Section title="20. Contact">
            <p>Questions about these Terms can be sent to legal@ohaccess.com. Support requests should go to support@ohaccess.com.</p>
            <p style={{ marginTop: '10px' }}>ohACCESS, LLC<br/>A Texas Limited Liability Company<br/>ohaccess.com</p>
          </Section>
      ...
      <footer style={{ background: '#111', padding: '40px 24px', textAlign: 'center', marginTop: '60px' }}>
        ...
        <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', marginBottom: '24px', flexWrap: 'wrap' }}>
          ...
          <a href="mailto:legal@ohaccess.com" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px', textDecoration: 'none' }}>Contact</a>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)' }}>© 2026 ohACCESS, LLC. All rights reserved.</div>
      </footer>
    </main>
  )
}
