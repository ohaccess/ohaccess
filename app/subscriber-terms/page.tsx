    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#ffffff', color: '#1d1d1f', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        <div style={{ marginBottom: '40px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#6e6e73' }}>For real estate agents, teams, and brokerages who hold an ohACCESS account · Version 1.3 · Effective Date: August 6, 2026 · ohaccess.com</div>
        </div>
        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>
          ...
          <Section title="4. Plans, Subscriptions, and Billing">
            ...
            <p style={{ marginTop: '10px' }}><strong>4.9 Promotional Hardware Offers.</strong> ohACCESS may from time to time offer physical promotional items, such as open house sign stands or sign frames (&ldquo;Promotional Hardware&rdquo;), to Subscribers who purchase qualifying Subscriptions. Unless the specific offer expressly states otherwise: (a) Promotional Hardware offers are available only to individual Pro Subscribers who purchase a two-year prepaid Subscription, are limited to one claim per Subscriber Account, and are not available on Team or Brokerage plans; a Subscriber who claims Promotional Hardware and later changes plans keeps the hardware but may not claim again; (b) offers are limited in quantity, including any per-state limits stated in the offer, with eligibility and state determined by the shipping address provided at checkout, and may be modified or withdrawn at any time as to future purchases; (c) Promotional Hardware ships only to addresses within the United States; (d) Promotional Hardware is a gift, has no cash or credit value, may not be redeemed for money or any discount, and may not be substituted, exchanged, or returned; (e) ohACCESS may fulfill Promotional Hardware through third-party retailers and carriers; delivery timelines are estimates only; (f) Promotional Hardware consists of third-party products provided &ldquo;as is&rdquo;; any product warranty is solely the manufacturer&apos;s, and ohACCESS disclaims all warranties with respect to Promotional Hardware to the fullest extent permitted by law; (g) unavailability, delay, loss, damage, or defect of Promotional Hardware does not entitle you to any refund, credit, offset, or cancellation of your Subscription, and Section 4.7 (Refunds) applies in full; and (h) if the associated Subscription payment is reversed, disputed, or charged back, ohACCESS may invoice you for the retail value of any Promotional Hardware already shipped.</p>
          </Section>
          ...
          <Section title="15. Term & Termination">
            ...
            <p style={{ marginTop: '10px' }}><strong>15.4 Effect of Termination.</strong> Upon termination, your right to access the Service immediately ceases. Sections 4.7 (Refunds), 4.9 (Promotional Hardware Offers), 6 (Subscriber Data), 7 (Acceptable Use), 8 (Marketing Compliance and indemnity references therein), 10 (Confidentiality), 11 (IP), 12.3 (Visitor Data Accuracy) and 12.5 (Disclaimers), 13 (Limitation of Liability), 14 (Indemnification), 15.4, 16, 17, 18, 19, and 20 survive termination.</p>
          </Section>
