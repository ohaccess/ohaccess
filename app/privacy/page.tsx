...
export const metadata: Metadata = {
  ...
  description: 'How ohACCESS collects, uses, and protects visitor and subscriber information.',
}
        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>
          ...
          <Section title="2. Information We Collect">
            ...
            <ul style={{ paddingLeft: '24px', marginTop: '8px', marginBottom: '16px' }}>
              ...
              <li style={{ marginBottom: '8px' }}>Phone number metadata obtained from the telecommunications provider, including the carrier name and phone line type (mobile, landline, or VoIP)</li>
          ...
          <Section title="3. How We Use Your Information">
            ...
            <ul style={{ paddingLeft: '24px', marginTop: '8px', marginBottom: '16px' }}>
              ...
              <li style={{ marginBottom: '8px' }}>Comply with legal, tax, regulatory, and investigatory obligations</li>
            </ul>
          ...
          <Section title="4. Data Sharing with Third Parties">
            ...
            <ul style={{ paddingLeft: '24px', marginTop: '8px', marginBottom: '12px' }}>
              ...
              <li style={{ marginBottom: '8px' }}><strong>Twilio Inc.</strong> — SMS delivery and phone number verification and lookup services</li>
          ...
          <Section title="10. Cookies and Tracking">
            <p>The ohACCESS platform uses minimal session cookies to maintain login state and prevent duplicate form submissions. We do not use third-party advertising cookies, tracking pixels, or behavioral advertising technologies on visitor-facing registration pages.</p>
            <p style={{ marginTop: '12px' }}>Our marketing website (the public pages of ohaccess.com, such as the homepage, blog, FAQ, contact, and sign-up pages) uses analytics and advertising tools to understand traffic and measure our own advertising, including the Meta Pixel (Meta Platforms, Inc.) and Google tags (Google Ads and Google Analytics, Google LLC). These tools set cookies and may collect device and browsing information on those pages, and Meta and Google may use that information as described in their own privacy policies, including to show ohACCESS ads to people who have visited our marketing pages. These tools are not loaded on visitor registration pages or on pages that display visitor information.</p>
            <p style={{ marginTop: '12px' }}>You can opt out of interest-based advertising through Meta&apos;s Ad Preferences, Google&apos;s Ads Settings, and the Digital Advertising Alliance at <a href="https://optout.aboutads.info" style={{ color: '#0071e3', textDecoration: 'underline' }}>optout.aboutads.info</a>. We honor the Global Privacy Control (GPC) browser signal: when your browser sends it, no advertising tools are loaded. You may also disable cookies in your browser settings, though this may affect platform functionality.</p>
          </Section>
