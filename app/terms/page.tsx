    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#ffffff', color: '#1d1d1f', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        ...
        <div style={{ background: '#fffbeb', border: '1px solid #f59e0b', borderRadius: '10px', padding: '14px 18px', marginBottom: '40px', fontSize: '13px', color: '#78350f', lineHeight: '1.6' }}>
          <strong>Notice:</strong> Version 1.5 adds visitor eligibility (18+) and an access-code use limit, a property-conduct/photography clause (Section 1D), an open-house cancellation and force-majeure section (9A), data-retention and California/other-state privacy cross-references to the Privacy Policy (5A, 5B), a state-telemarketing acknowledgment (Section 3), a general severability clause (13.5), an in-document version and effective date (Section 14), and availability of these Terms in an accessible format (Section 15). Version 1.4 added Section 1C (ohACCESS&apos;s primary purpose as a safety and security tool, with verification limited to confirming reachable contact information — no background checks and no guarantee of any person&apos;s safety, identity, or intentions). Version 1.3 added Section 1B (open-house attendance is at the discretion of the seller and hosting Agent, with the Fair Housing Act and other anti-discrimination law as the controlling guardrail). Earlier v1.2 (&quot;Your Alternative to Acceptance&quot;) and v1.1 strengthening of Limitation of Liability, Indemnification, and Class Action Waiver remain in effect. Pending formal review by a qualified Texas attorney.
        </div>
        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>
          ...
          <Section title="1B. Access Is at the Discretion of the Seller and Hosting Agent">
            ...
            <p style={{ marginTop: '10px' }}><strong>Non-Discrimination.</strong> Any refusal, conditioning, or removal must be made in a manner that complies with the federal Fair Housing Act (42 U.S.C. &sect;&sect; 3601 <em>et seq.</em>), the Civil Rights Act of 1866 (42 U.S.C. &sect; 1981), the Americans with Disabilities Act where applicable, and all state and local fair-housing and anti-discrimination laws. The hosting Agent and the property owner may not refuse or condition access on the basis of race, color, national origin, religion, sex (including sexual orientation and gender identity), familial status, disability, age, marital status, source of income, military or veteran status, or any other class protected under federal, state, or local law in the jurisdiction where the property is located. Section 7 of the <a href="/subscriber-terms" style={{ color: '#0071e3', textDecoration: 'underline' }}>ohACCESS Subscriber Terms of Service</a> independently prohibits any ohACCESS account holder from engaging in discriminatory access decisions and treats any such conduct as grounds for immediate termination of the account holder&apos;s ohACCESS subscription.</p>
            <p style={{ marginTop: '10px' }}><strong>If You Believe You Were Refused Unlawfully.</strong> If you believe you were refused access in violation of fair-housing or anti-discrimination law, you may file a complaint with the U.S. Department of Housing and Urban Development at <strong>1-800-669-9777</strong> or <a href="https://www.hud.gov/program_offices/fair_housing_equal_opp/online-complaint" target="_blank" rel="noopener noreferrer" style={{ color: '#0071e3', textDecoration: 'underline' }}>hud.gov</a>, contact your state attorney general or state real estate commission, and/or report the incident to ohACCESS at <a href="mailto:privacy@ohaccess.com" style={{ color: '#0071e3', textDecoration: 'underline' }}>privacy@ohaccess.com</a>. ohACCESS will preserve any registration and access-related records associated with the incident pursuant to a good-faith complaint or lawful request.</p>
          ...
          <Section title="1C. Purpose of ohACCESS — Security, Follow-Up, and Related Services">
            ...
            <p style={{ marginTop: '10px' }}>ohACCESS verifies only that the phone number and/or email address you provide are valid and reachable, by delivering an access code to them. <strong>ohACCESS does not conduct background checks, criminal-history checks, or identity verification beyond this contact-information confirmation, and does not screen, vouch for, or guarantee the safety, identity, or intentions of any visitor, Agent, or other person.</strong> Sections 1B and 11 continue to apply.</p>
            ...
            <p style={{ marginTop: '10px' }}>The hosting Agent also uses ohACCESS to follow up with you regarding the property you visited and other real estate services, as described in Sections 2, 4, and 8, and ohACCESS may facilitate introductions to the categories of real estate&ndash;related service providers described in Section 5. These follow-up and service-provider purposes operate alongside, and are secondary to, the security purpose described above.</p>
          </Section>
          ...
          <Section title="5A. Data Retention">
            <p>We retain your registration information only as long as needed for the purposes described in these Terms and our <a href="/privacy" style={{ color: '#0071e3', textDecoration: 'underline' }}>Privacy Policy</a>. As described in Section 5 of the Privacy Policy, visitor registration data is retained for up to three (3) years from the date of collection, or until the hosting Agent deletes their ohACCESS account, whichever comes first, after which it is permanently deleted — subject to any legal obligation to retain certain records. You may request deletion of your data at any time by emailing privacy@ohaccess.com; see the Privacy Policy for details and timing.</p>
          </Section>

          <Section title="5B. California Residents and Other State Privacy Rights">
            <p>If you are a resident of California or another U.S. state with a comprehensive consumer-privacy law, you may have additional rights regarding your personal information — including the right to know what we collect, to access, correct, or delete it, and to opt out of any &quot;sale&quot; or &quot;sharing&quot; of it. <strong>ohACCESS does not sell personal information to data brokers.</strong> These rights, and how to exercise them, are described in Section 7 of our <a href="/privacy" style={{ color: '#0071e3', textDecoration: 'underline' }}>Privacy Policy</a>. California residents may opt out of any sale or sharing by emailing privacy@ohaccess.com with the subject line &quot;California Opt Out&quot;; residents of other states may use the subject line &quot;[State] Privacy Request.&quot;</p>
          </Section>
        ...
        <p style={{ marginTop: '12px' }}>The Agent&apos;s follow-up communications are intended solely to provide you with information about available properties and real estate services. You are under no obligation to work with the Agent or their brokerage as a result of your registration or any subsequent communications.</p>
          ...
          <Section title="15. Contact Information">
            ...
            <p style={{ marginTop: '12px' }}><strong>Accessible Formats.</strong> If you need these Terms in an alternative accessible format, contact us at privacy@ohaccess.com and we will provide them in a reasonably accessible format at no charge.</p>
          </Section>
