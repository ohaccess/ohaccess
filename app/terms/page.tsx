      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8', color: '#3a3a3c' }}>
          ...
          <Section title="5A. Data Retention">
            We retain your registration information only as long as needed for the purposes described in these Terms and our Privacy Policy. As described in Section 5 of the Privacy Policy, visitor registration data is retained for up to three (3) years from the date of collection, or until the hosting Agent deletes their ohACCESS account, whichever comes first, after which it is permanently deleted — subject to any legal obligation to retain certain records. You may request deletion of your data at any time by emailing privacy@ohaccess.com; see the <a href="/privacy" style={{ color: '#0071e3', textDecoration: 'underline' }}>Privacy Policy</a> for details and timing.
          </Section>
