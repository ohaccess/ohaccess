    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#ffffff', color: '#1d1d1f', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 40px' }}>
        <div style={{ marginBottom: '40px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#6e6e73' }}>For individuals registering at an open house · Version 1.3 · Effective Date: June 1, 2026 · ohaccess.com</div>
        ...
        <div style={{ background: '#fffbeb', border: '1px solid #f59e0b', borderRadius: '10px', padding: '14px 18px', marginBottom: '40px', fontSize: '13px', color: '#78350f', lineHeight: '1.6' }}>
          <strong>Notice:</strong> Version 1.3 adds Section 1B clarifying that open-house attendance is at the discretion of the seller and hosting Agent (with the Fair Housing Act and other anti-discrimination law as the controlling guardrail). Earlier v1.2 (&quot;Your Alternative to Acceptance&quot;) and v1.1 strengthening of Limitation of Liability, Indemnification, and Class Action Waiver remain in effect. Pending formal review by a qualified Texas attorney.
        </div>
